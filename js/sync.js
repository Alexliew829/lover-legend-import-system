...
const CLOUD_BOOTSTRAP_KEY = "importSystemCloudBootstrapV427";
...
async function runCloudSync() {
  ...
  try {
    ...
    // V4.28 hard bootstrap: this version's first successful sync is ALWAYS a full Pull.
